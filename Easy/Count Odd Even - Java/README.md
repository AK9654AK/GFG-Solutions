<h2><a href="https://practice.geeksforgeeks.org/problems/count-odd-even-java/1?page=1&status[]=bookmarked&sortBy=submissions">Count Odd Even - Java</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px"><em>Congrats on completing Module 1.</em></span></p>
