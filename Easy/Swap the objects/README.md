<h2><a href="https://practice.geeksforgeeks.org/problems/swap-the-objects/1?page=3&difficulty[]=0&sortBy=accuracy">Swap the objects</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px"><em>Classes and objects are one of the most important part of C++. </em><br>
