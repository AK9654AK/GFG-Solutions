<h2><a href="https://practice.geeksforgeeks.org/problems/biginteger-multiply/1?page=1&difficulty[]=0&sortBy=accuracy">BigInteger Multiply</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two BigIntegers <strong>X</strong> and <strong>Y</strong>. You have&nbsp;to multiply X and Y.</span></p>
