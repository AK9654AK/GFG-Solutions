<h2><a href="https://practice.geeksforgeeks.org/problems/sum-of-product-of-x-and-y-with-floornx-y3711/1?page=2&difficulty[]=-1&sortBy=accuracy">Sum of product of x and y with floor(n/x) = y</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive integer&nbsp;n. Find the sum of product of&nbsp;x&nbsp;and&nbsp;y&nbsp;such that floor(n/x)&nbsp;= y&nbsp;.</span><br>
&nbsp;</p>
