<h2><a href="https://practice.geeksforgeeks.org/problems/mind-game3637/1?page=3&difficulty[]=-1&sortBy=accuracy">Mind Game</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Someone is asked to perform the following operations on a randomly chosen number between 1 and 10.</span></p>
